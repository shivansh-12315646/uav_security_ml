...
def api_detect(request):
    ...
    try:
        ...
        detection = DetectionHistory.objects.create(
            ...
            direction=features[2], signal_strength=features[3],
            distance_from_base=features[4], flight_time=features[5],
            battery_level=features[6], temperature=features[7],
            vibration=features[8], gps_accuracy=features[9],
